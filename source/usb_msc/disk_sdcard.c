...
sd_card_t *usbDeviceMscCard = &g_sd;
...
//    NVIC_SetPriority((IRQn_Type)irqNumber, 30);
//    NVIC_SetPriority(126, (30 - 1U));
//    NVIC_SetPriority(SD_HOST_IRQ, (30 - 1U));
...
void USB_DeviceApplicationInit(void)
{
    ...
    {
        usb_echo("USB device mass storage start\r\n");
