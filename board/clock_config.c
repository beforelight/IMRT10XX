...
- {id: FLEXSPI_CLK_ROOT.outFreq, value: 2160/17 MHz}
- {id: GPT1_ipg_clk_highfreq.outFreq, value: 50 MHz}
- {id: GPT2_ipg_clk_highfreq.outFreq, value: 50 MHz}
...
- {id: CCM.LPI2C_CLK_PODF.scale, value: '5', locked: true}
...
- {id: CCM_ANALOG.PLL3_PFD0_DIV.scale, value: '17', locked: true}
...
/*******************************************************************************
 * Variables for DCD_HSRUN configuration
 ******************************************************************************/
const clock_arm_pll_config_t armPllConfig_DCD_HSRUN =
    {
        .loopDivider = 100,                       /* PLL loop divider, Fout = Fin * 50 */
        .src = 0,                                 /* Bypass clock source, 0 - OSC 24M, 1 - CLK1_P and CLK1_N */
    };
const clock_sys_pll_config_t sysPllConfig_DCD_HSRUN =
    {
...
const clock_usb_pll_config_t usb1PllConfig_DCD_HSRUN =
    {
        .loopDivider = 0,                         /* PLL loop divider, Fout = Fin * 20 */
        .src = 0,                                 /* Bypass clock source, 0 - OSC 24M, 1 - CLK1_P and CLK1_N */
    };
const clock_enet_pll_config_t enetPllConfig_DCD_HSRUN =
    {
...
/*******************************************************************************
 * Code for DCD_HSRUN configuration
 ******************************************************************************/
void DCD_HSRUN(void)
{
    ...
    /* Set LPI2C_CLK_PODF. */
    CLOCK_SetDiv(kCLOCK_Lpi2cDiv, 4);
    ...
    /* Init ARM PLL. */
    CLOCK_InitArmPll(&armPllConfig_DCD_HSRUN);
    /* In SDK projects, SDRAM (configured by SEMC) will be initialized in either debug script or dcd.
     * With this macro SKIP_SYSCLK_INIT, system pll (selected to be SEMC source clock in SDK projects) will be left unchanged.
     * Note: If another clock source is selected for SEMC, user may want to avoid changing that clock as well.*/
#ifndef SKIP_SYSCLK_INIT
...
#endif
    /* Init System PLL. */
    CLOCK_InitSysPll(&sysPllConfig_DCD_HSRUN);
    /* Init System pfd0. */
...
#if !(defined(XIP_EXTERNAL_FLASH) && (XIP_EXTERNAL_FLASH == 1))
    /* Init Usb1 PLL. */
    CLOCK_InitUsb1Pll(&usb1PllConfig_DCD_HSRUN);
    /* Init Usb1 pfd0. */
    CLOCK_InitUsb1Pfd(kCLOCK_Pfd0, 17);
    /* Init Usb1 pfd1. */
    ...
    /* Init Enet PLL. */
    CLOCK_InitEnetPll(&enetPllConfig_DCD_HSRUN);
    /* Disable pfd offset. */
    ...
    SystemCoreClock = DCD_HSRUN_CORE_CLOCK;
}
